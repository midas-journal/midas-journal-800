...
/**
 * Tests the NormalizedGradientCorrelationMultiImageMetric with a synthetic
 * image of a Gaussian, centered at the origin. Fixed images are projections
 * along the x axis (focal distance = 200 mm, distance from origin to detector
 * = 40 mm) and along the y axis (same parameters as the first one ).
 *
