...
/**
 * Tests the MeanSquaresMultiImageMetric with a synthetic image of a Gaussian,
 * centered at the origin. Fixed images are projections along the x axis
 * (focal distance = 200 mm, distance from origin to detector = 40 mm) and
