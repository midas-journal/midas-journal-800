...
/**
 * Tests the GradientDifferenceMultiImageMetric with a synthetic image of a
...
// Set up  the Metric
//-----------------------------------------------------------
  typedef itk::GradientDifferenceMultiImageToImageMetric<
...
//-----------------------------------------------------------
  ...
  typedef MultiMetricType::InterpolatorPointer    InterpolatorPointer;
